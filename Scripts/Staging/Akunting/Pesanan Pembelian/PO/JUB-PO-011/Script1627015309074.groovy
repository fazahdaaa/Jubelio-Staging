...
WebUI.setText(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/txtNoPesanan'), 'AUTO-PO-04')
...
WebUI.click(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/txtTanggal'), FailureHandling.STOP_ON_FAILURE)

WebUI.clearText(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/txtTanggal'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/txtTanggal'), '30 Juni 2020')
...
WebUI.click(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/cbxHargaTermasukPajak'))

WebUI.verifyElementChecked(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/cbxHargaTermasukPajak'), 
    0)
...
WebUI.doubleClick(findTestObject('Test/Page_Jubelio - Pembelian/txtNilaiDiskon'))

WebUI.setText(findTestObject('Object Repository/Test/Page_Jubelio - Pembelian/input_Online_editor-main'), '400')

WebUI.doubleClick(findTestObject('Object Repository/Test/Page_Jubelio - Pembelian/div_PPN'))

WebUI.delay(GlobalVariable.medDelay)

WebUI.click(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/optPajakList - PPN'))
...
WebUI.click(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/btnNomorListBarang - 1'))

WebUI.scrollToElement(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/cbxTutupPesananPembelian'), 
    0)

WebUI.click(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/cbxTutupPesananPembelian'))
