...
WebUI.setText(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Penerimaan Barang/txtNoTagihan'), 'AUTO-BILL-03')
...
WebUI.setText(findTestObject('Test/Page_Jubelio - Penerimaan Barang/input_Online_editor-main - Copy'), '3')
