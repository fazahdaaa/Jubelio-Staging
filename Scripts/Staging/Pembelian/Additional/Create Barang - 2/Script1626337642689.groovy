...
WebUI.setText(findTestObject('Barang/Barang - Katalog/Barang - Katalog - In Review/txtBeratPaket'), '999')
...
WebUI.setText(findTestObject('Barang/Barang - Katalog/Barang - Katalog - In Review/txtHargaDefault'), '999')
