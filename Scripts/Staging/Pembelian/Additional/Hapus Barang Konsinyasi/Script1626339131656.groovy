...
WebUI.delay(GlobalVariable.medDelay, FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Barang/Barang - Katalog/Barang - Katalog - In Review/btnHapusItemKonsinyasi1'))

WebUI.click(findTestObject('Barang/Barang - Katalog/Barang - Katalog - In Review/btnKonfirmasiHapusItem - Ya'))
