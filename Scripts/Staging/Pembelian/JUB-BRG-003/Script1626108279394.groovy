...
WebUI.setText(findTestObject('Barang/Barang - Katalog/Barang - Katalog - In Review/txtNama'), 'Masker 6pcs Konsinyasi Item')
...
WebUI.setText(findTestObject('Barang/Barang - Katalog/Barang - Katalog - In Review/txtSKU'), 'KONSINYASI01')
...
WebUI.setText(findTestObject('Object Repository/Test/Page_Jubelio - In Review/div_dgadfgsdfgfdgdsfgfgdf'), 'BBarang Masker 6pcs untuk tester konsinyasi item pertama')
...
WebUI.click(findTestObject('Barang/Barang - Katalog/Barang - Katalog - In Review/tglProdukKonsinyasi'))
...
WebUI.callTestCase(findTestCase('Staging/Pembelian/Additional/Hapus Barang Konsinyasi'), [:], FailureHandling.STOP_ON_FAILURE)
