...
WebUI.openBrowser(GlobalVariable.linkStaging)
...
WebUI.setText(findTestObject('Login/txtEmail'), GlobalVariable.userStaging)

WebUI.setText(findTestObject('Login/txtPassword'), 'Test')

WebUI.click(findTestObject('Login/btnMasuk'))

WebUI.verifyTextPresent('Password harus di antara 6 dan 30.', false)
