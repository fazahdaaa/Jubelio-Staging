...
WebUI.callTestCase(findTestCase('Production/Pembelian/Additional/Create Barang'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Akunting/Akunting - Pembelian/Akunting - Pembelian - Pesanan Pembelian/txtNoPesanan'), '[auto]-BILL-01')
