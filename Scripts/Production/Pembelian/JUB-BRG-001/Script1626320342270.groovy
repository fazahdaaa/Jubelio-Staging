...
WebUI.callTestCase(findTestCase('Production/Login/001'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Production/Pembelian/Additional/Hapus Barang'), [:], FailureHandling.STOP_ON_FAILURE)
