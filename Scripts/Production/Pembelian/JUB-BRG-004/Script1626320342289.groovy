...
WebUI.setText(findTestObject('Barang/Barang - Katalog/Barang - Katalog - In Review/txtSKU'), 'BUNDLE01')

WebUI.setText(findTestObject('Barang/Barang - Katalog/Barang - Katalog - In Review/txtDescription'), 'Barang Masker 6pcs untuk tester bundle item pertama ')
